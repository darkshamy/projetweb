...
<form name="Form2" method="POST" onsubmit="chercher.php">
	...
	<fieldset>
		...
		<div align="center" >
    <table align="center" border="3" hight width="1000"  >
			<tr>
				<th> Code Produit </th>	<th> Marque </th>	<th> Couleur </th>	<th> Type </th>	<th>Date</th>
...
if((!isset($_POST['chercher'])) || ((isset($_POST['chercher']) && (!isset($_POST['recherch']))
		...
		?>
			...
			<div class="avds_large">
				<div class="avds_background" style=""></div>
				<div class="avds_large_container">
					<div class="avds_large_content">
						<div class="avds_title">Cameras de surveillances</div>
