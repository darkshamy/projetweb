...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Numen</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="mprod1.php"><i class="fa fa-circle-o"></i> Modifier produit</a></li>
            <li><a href="sprod1.php"><i class="fa fa-circle-o"></i> Supprimer Produit</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="mstock1.php"><i class="fa fa-circle-o"></i> Modifier Stock</a></li>
            <li><a href="sstock1.php"><i class="fa fa-circle-o"></i> Supprimer Stock</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <center><legend><h1>Gestion de Stock & Produit</h1></legend></center>
      </h1>
    </section>
